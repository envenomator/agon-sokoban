...
#
# ZDS II Make File - Sokoban project, Debug configuration
#
...
# project directory
PRJDIR = C:\source\agon-sokoban\game
PRJDIR_ESCSPACE = C:\source\agon-sokoban\game

# intermediate files directory
WORKDIR = C:\source\agon-sokoban\game\Debug
WORKDIR_ESCSPACE = C:\source\agon-sokoban\game\Debug

# output files directory
OUTDIR = C:\source\agon-sokoban\game\Debug\
OUTDIR_ESCSPACE = C:\source\agon-sokoban\game\Debug\
...
LDFLAGS = @..\Sokoban.linkcmd
build: Sokoban relist

buildall: clean Sokoban relist

relink: deltarget Sokoban

deltarget: 
	@if exist "$(WORKDIR)\Sokoban.lod"  \
            $(RM) "$(WORKDIR)\Sokoban.lod"
	@if exist "$(WORKDIR)\Sokoban.hex"  \
            $(RM) "$(WORKDIR)\Sokoban.hex"
	@if exist "$(WORKDIR)\Sokoban.map"  \
            $(RM) "$(WORKDIR)\Sokoban.map"
...
relist: 
	$(AS) $(ASFLAGS) -relist:"C:\source\agon-sokoban\game\Debug\Sokoban.map" \
            C:\source\agon-sokoban\game\init.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\agon-sokoban\game\Debug\Sokoban.map" \
            C:\source\agon-sokoban\game\Debug\main.src
	$(AS) $(ASFLAGS) -relist:"C:\source\agon-sokoban\game\Debug\Sokoban.map" \
            C:\source\agon-sokoban\game\mos-interface.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\agon-sokoban\game\Debug\Sokoban.map" \
            C:\source\agon-sokoban\game\Debug\vdp.src
	$(AS) $(ASFLAGS) -relist:"C:\source\agon-sokoban\game\Debug\Sokoban.map" \
            C:\source\agon-sokoban\game\Debug\game.src
	$(AS) $(ASFLAGS) -relist:"C:\source\agon-sokoban\game\Debug\Sokoban.map" \
